...
import ForgotPasswordScreen from '../screens/authentication/ForgotPasswordScreen'; // Adjust path if needed
    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        tabBarIcon: ({ color, focused }) => {
          ...
          return <Icon name={iconName} size={width * 0.06} color={focused ? 'tomato' : 'blue'} />;
        },
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        />
        <Stack.Screen 
          name="ForgotPassword"  // Name it "ForgotPassword" instead of "ForgotPasswordFlow"
          component={ForgotPasswordScreen}   // Add ForgotPasswordScreen here
          options={{ headerShown: false }} 
        />
        <Stack.Screen 
          name="OtpScreen" 
